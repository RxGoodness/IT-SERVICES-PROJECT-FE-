  ...
  <div className={classes.details}>
      <div className={classes.img}>
        ...
        <div className={classes.titled}>
          ...
          <div>
            <div>
              <p className={classes.para}><i className={classes.briefCase}>{briefCase}</i>{props.employmentType || 'Employment Type'}</p>
            </div>
            <div>
              <p className={classes.para}><i className={classes.briefCase}>{location}</i>{props.location || 'Location'}</p>
            </div>
          </div>
        </div>
      </div>
